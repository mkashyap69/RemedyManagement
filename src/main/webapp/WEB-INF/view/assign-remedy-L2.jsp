...
<div class="sub-container">
  ...
  <td>${remId}</td>
    ...
    <td><a href="/assign-remedy?id=${l2.id}" class="btn btn-info" role="button" style="background-image: linear-gradient(-90deg, #ccffff, #ffb8ff); color:black;">Assign</a></td>
  </tr>
  </c:forEach>
  </tbody>
  </table>
