...
<div class="sub-container">
  ...
  <td>${remId}</td>
    ...
    <td><a href="/transfer-remedy?id=${l1.id}" class="btn btn-info" role="button" style="background-image: linear-gradient(-90deg, #ccffff, #ffb8ff); color:black;">Transfer</a></td>
  </tr>
  </c:forEach>
  </tbody>
  </table>
