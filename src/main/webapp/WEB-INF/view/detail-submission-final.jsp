...
.form-group{
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <h3>Your details are submitted successfully. And your User Id is <strong>${id}</strong></h3>
     <a href="/login" class="btn btn-success" role="button"  style="background-image: linear-gradient(-90deg, #ccffff, #ffb8ff); color:black;">Login</a>
    </div>
