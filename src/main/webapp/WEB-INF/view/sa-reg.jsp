  ...
  <div class="container-fluid">
    ...
    <div class="container">
      ...
      <h2>WELCOME ! Enter the following details </h2>
        ...
        <form:form class="reg" action="/sa-reg" method="post" modelAttribute="details">
...
<%--   <form:label path="contact">Contact Number</form:label> --%>
  <form:input class="form-control" type="text" path="contact" placeholder="Contact"/>
...
<div class="form-group">
  ...
  <form:input class="form-control" type="date" path="dob" placeholder="DOB"/>
</div>
<div class="form-group">
...
<div class="form-group">
 <%--  <form:label path="level">Support Level</form:label> --%>
  <form:select class="form-control" path="level" placeholder="Support Level">
